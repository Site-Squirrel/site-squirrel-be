...
RSpec.describe 'User Trips Request' do
  describe 'User Trips Index' do
    it "can render all of a user's trips" do
      ...
      trip_attribute_keys = %i[name campground_id vehicle_length tent_site_ok campground_location start_date
                               number_nights]
      user_1 = create(:user)
  ...
  describe 'User Trips create' do
    it 'can create a new trip' do
      user_1 = create(:user)
      trip_keys = %i[id type attributes]
      trip_attr_keys = %i[name campground_id vehicle_length tent_site_ok campground_location start_date
                          number_nights]
